...
const Header = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50  flex items-center justify-between px-5 w-full bg-black">
        <div>
          <Link to="/">
        ...
        <div className="lg:hidden">
          <button
            ...
            className="text-white text-sm uppercase tracking-wider transition duration-150 ease-out"
          >
            {isOpen ? <AiOutlineClose size={30} color="#fff"/> : <AiOutlineBars size={30}/>}
          </button>
        </div>
      </header>
    </>
